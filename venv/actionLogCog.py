...
import discord
import asyncio
import AutoPilot, moderationCog, rankingsCog,psutil
import datetime
import time
...
class AnActionLogModule(commands.Cog):
    def __init__(self, bot):
        self.client = bot
        self.modUtility = moderationCog.AnModUtilityModule(self.client)
        self.ranking = rankingsCog.AnActivityModule(self.client)
        self.ignoreRole = []
    ...
    async def on_guild_join(self, Guild):
        ...
        ServerSettings.update({str(Guild.id): {}})